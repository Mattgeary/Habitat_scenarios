...
gc()
output.7 <- paste(getwd(), "Scenario_7/Revisions_AIC", sep="/")
...
writeRaster(pred, filename=(paste(getwd(), "Scenario_7/Revisions_AIC", paste("pred_map_REVISIONS_AIC", j, ".grd", sep= ""), sep="/")), overwrite=T)
...
write.csv(pres.abs, "Scenario_7_REVISIONS_AIC.csv", row.names=F)
setwd(work)